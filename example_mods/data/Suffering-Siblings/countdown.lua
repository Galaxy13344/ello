...
-----
setProperty('pibby.x', (getProperty('gf.x'))-200)
setProperty('pibby.y', (getProperty('gf.y'))-170)
end
...
setProperty('pibby.x', (getProperty('gf.x'))-200)
setProperty('pibby.y', (getProperty('gf.y')-165))
...
setProperty('pibby.x', (getProperty('gf.x')-220))
setProperty('pibby.y', (getProperty('gf.y')-310))
end
...
setProperty('pibby.x', (getProperty('gf.x'))-200)
setProperty('pibby.y', (getProperty('gf.y')-145))
end
